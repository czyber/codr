...
query_prompt_template = ChatPromptTemplate.from_messages(
    [
        ("system", """You are an exceptional Senior Software Engineer. For the given task, come up with queries that will help locate the files that need changes. \
        Here is an example
...
class CodeChanges(BaseModel):
    code_changes: List[CodeChange] = Field(..., description="List of code changes to be made")
...
code_change_prompt = ChatPromptTemplate.from_messages(
    [
        ("system", """You are an exceptional Principal Software Engineer. For the given task and code snippet, come up with necessary code changes. \
...
code_edit_system_message = SystemMessage(content="""You are an exceptional Principal Software Engineer. For the given task and code snippet, come up with necessary code changes. \
        It might be the case that the snippet does not need any changes. \
        Think step by step if a code change you would do actually is necessary for achieving the task. \
        Focus solely on the task, do not reformat the code or make any other changes. Only touch the code that is totally necessary to complete the task. \
        Make ALL necessary changes and do not skip any, since your code changes will be used to update the codebase.
...
verify_prompt_template = ChatPromptTemplate.from_messages(
    [
        ("system", """You are an exceptional Senior Software Engineer. For the given task and code snippet, verify the code changes that the Principal Software Engineer has made. \
